...
const Heading = ({
  ...
  return (
<div className="w-[1920px] h-[410px]  m-auto">
  <div className="w-[1920px] h-[410px] opacity-100">
    <Image
  ...
  <div className="relative">
    <h1 className="absolute  w-[30%] h-[60px] flex justify-center items-center -mt-[208px] text-[48px] text-white font-semibold left-[50%] transform -translate-x-[50%]">
      {Heading}
    </h1>
