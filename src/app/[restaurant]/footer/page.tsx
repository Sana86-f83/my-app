...
const Footer = () => {
  return (
    <div className="h-[740.15px] w-[1920px] text-white">
      {/* // main Footer Div */}
      <div className="h-[597.15px] w-[1320px]  ml-[300px] mt-[120px] flex relative text-white ">
        ...
        <div className="h-[367px] w-[1320px] absolute mt-[207px]  ">
          ...
          <div className="h-[363px] w-[244px] absolute flex ml-[1076px] ">
            ...
            <div className="h-[53px] w-[244px] absolute mt-[55px] ">
              <Image
                src={"/footer/unsplash_CLMpC9UhyTo.png"}
                alt="unsplash_CLMpC9UhyTo Image"
                width={59}
                height={48}
                className=""
              ></Image>
